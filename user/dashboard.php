...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../asset/js/admin/gritter/css/jquery.gritter.css" />
    ...
    <script src="../asset/js/admin/chart-master/Chart.js"></script>
